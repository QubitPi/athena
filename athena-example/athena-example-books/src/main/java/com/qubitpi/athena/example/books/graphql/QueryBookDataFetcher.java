...
@Immutable
@ThreadSafe
public class QueryBookDataFetcher implements DataFetcher<MetaData> {
     ...
     */
    public QueryBookDataFetcher(final @NotNull Map<String, MetaData> bookMetaData) {
    ...
    public MetaData get(final DataFetchingEnvironment dataFetchingEnvironment) {
        ...
        return bookMetaData.get(fileId);
    }
}
