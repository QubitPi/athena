...
class BooksBinderFactorySpec extends Specification {
    ...
    def getTestIterationData() {
        [
                ['io.github.qubitpi.athena.example.books.application.BooksBinderFactory$DerbyDataSourceProvider', "Derby"],
                ['io.github.qubitpi.athena.example.books.application.BooksBinderFactory$MySQLDataSourceProvider', "MySQL"]
        ]
    }
}
