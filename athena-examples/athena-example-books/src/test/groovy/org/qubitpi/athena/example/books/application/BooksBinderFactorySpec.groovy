...
class BooksBinderFactorySpec extends Specification {
    ...
    def getTestIterationData() {
        [
                ['application.books.example.org.qubitpi.athena.BooksBinderFactory$DerbyDataSourceProvider', "Derby"],
                ['application.books.example.org.qubitpi.athena.BooksBinderFactory$MySQLDataSourceProvider', "MySQL"]
        ]
    }
}
